...
module.exports = function (config) {
    config.set({
        ...
        files: [
            ...
            'src/main/webapp/bower_components/angular-bootstrap-lightbox/dist/angular-bootstrap-lightbox.js',
            'src/main/webapp/bower_components/webcam/dist/webcam.min.js',
