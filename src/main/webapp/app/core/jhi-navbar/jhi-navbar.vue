    ...
    <b-navbar toggleable="md" type="dark" class="jh-navbar">
        <div class="jh-logo-container float-left">
            ...
            <b-navbar-brand class="logo float-left" b-link to="/">
                ...
                <span v-text="$t('global.title')" class="navbar-title">WorkshopSilver</span> <span class="navbar-version">{{version}}</span>
            </b-navbar-brand>
        </div>
        <b-collapse is-nav id="header-tabs">
            <b-navbar-nav class="ml-auto">
                ...
                <b-nav-item-dropdown
                    ...
                    <b-dropdown-item to="/entity/model">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.model')">Model</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/entity/mold">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.mold')">Mold</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/entity/photo">
                        <font-awesome-icon icon="asterisk" />
